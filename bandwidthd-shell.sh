...
cat /tmp/log.3.*.cdf | grep -v  0.0.0.0 | awk -F "," '{print $1, "NA", "NA" ,$2,$3,$10}' > /tmp/cleanlog
...
## Will implement a module later on that will add these symerlink if they don't exists
